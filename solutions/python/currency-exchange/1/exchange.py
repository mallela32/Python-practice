...
def get_leftover_of_bills(amount, denomination):
    ...
    """
    no_of_notes_we_can_get = int(amount / denomination)
    final_amount = denomination * no_of_notes_we_can_get
    return float(amount - final_amount)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    exchange_rate_including_spread = exchange_rate + (exchange_rate*spread/100) 
    money_we_can_exchange = budget / exchange_rate_including_spread
    no_of_notes_we_can_get = int(money_we_can_exchange / denomination)
    final_amount = denomination * no_of_notes_we_can_get
